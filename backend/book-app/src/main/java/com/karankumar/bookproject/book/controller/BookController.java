 ...
 */
 ...
 public class BookController {
   ...
   private final RestTemplate restTemplate;
     ...
     // Consider injecting RestTemplate through constructor if it's defined as a Bean
     public BookController(BookService bookService, PredefinedShelfService predefinedShelfService, ModelMapper modelMapper, RestTemplate restTemplate) {
         this.bookService = bookService;
         this.predefinedShelfService = predefinedShelfService;
         this.modelMapper = modelMapper;
   ...
   @GetMapping("/recommendations")
     public ResponseEntity<String> getRecommendations() {
         try {
             String url = "https://book-finder1.p.rapidapi.com/api/search?lexile_max=800&results_per_page=25"; // Add actual query parameters
 
             HttpHeaders headers = new HttpHeaders();
             headers.set("X-RapidAPI-Key", "dad455c774msh199672d06358df5p1360fcjsn5c5726f3139f");
             ...
             return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("An error occurred while fetching recommendations.");
         }
     }
 }
