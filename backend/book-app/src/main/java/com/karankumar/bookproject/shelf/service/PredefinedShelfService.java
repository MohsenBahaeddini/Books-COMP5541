...
import static com.karankumar.bookproject.shelf.model.PredefinedShelf.ShelfName.FAVORITES;
...
public class PredefinedShelfService {
  ...
  public PredefinedShelf findFavoritesShelf() {
    return findByPredefinedShelfNameAndLoggedInUser(FAVORITES).orElse(null);
  }
  ...
  public static Optional<ShelfName> getPredefinedShelfName(@NonNull String predefinedShelfName) {
    switch (predefinedShelfName) {
      case "Favorites":
        return Optional.of(ShelfName.FAVORITES);
      case "To read":
